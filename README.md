...
Summary: The `webapp` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x.  
Target Product: WFK  
...
The `webapp` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x. It 
...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="org.webapp.controller"/>` 
